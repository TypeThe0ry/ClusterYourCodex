...
Assert-SetupSilent ([string]$previewManifest.productVersion -match '^[0-9]+\.[0-9]+\.[0-9]+(?:-(preview|alpha|beta|rc)\.[0-9]+)?$') 'package manifest carries a strict release product version'
