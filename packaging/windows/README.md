...
```json
{"schemaVersion":"cyc.dev/codex-integration-receipt/v1","status":"unchanged","pluginId":"cluster-your-codex@clusteryourcodex","pluginVersion":"0.1.0-preview.3","agentsBlockSha256":"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"}
```
