...
| Clean Windows 11 standard/admin/profile matrix | preview.75 hosted ARM64 x64-emulation matrix passed; the next tagged prerelease repeats the acceptance with the selector guard and Windows live round-trip probe; independent external clean-VM GA evidence remains a GA blocker |
